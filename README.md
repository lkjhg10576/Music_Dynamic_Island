...
[![Version](https://img.shields.io/badge/version-0.5.0-4-blue)](https://github.com/lkjhg10576/Music_Dynamic_Island)
...
这是一个 Windows 桌面灵动岛组件。屏幕顶部的小岛会实时显示网速与正在播放的音乐，并支持流量统计、系统通知、系统状态提醒、实时活动（专注番茄钟 / 倒计时 / 硬件监控 / 健康提醒 / 系统动态感知）与硬件监控；多个实时活动可同时并行，也能吸附在任务栏左下角。
...
│   ├── views/
│   │   ├── MainPanel.vue         # 主控制台（设置、统计、音乐、实时状态）
